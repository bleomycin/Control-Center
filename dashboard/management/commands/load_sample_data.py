    ...
    def handle(self, *args, **options):
        ...
        prop_data = [
            ("1200 Oak Avenue", "1200 Oak Ave, Austin, TX 78701", "Travis County, TX", "Single Family",
             ...
             []),  # Sole ownership (Blaine - implied, no partners listed)
        ...
        loan_data = [
            ("First National - Oak Ave Mortgage", "Blaine (personal)",
            ...
            ("First National - Elm St Mortgage", "Blaine & Tom Driscoll (50/50)",
            ...
            ("Huang Bridge Loan - Magnolia", "Blaine & Nina Patel",
            ...
            ("Vehicle Loan - F-150", "Blaine (personal)",
