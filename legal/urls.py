...
urlpatterns = [
    ...
    path("<int:pk>/firm-engagements/add/", views.firm_engagement_add, name="firm_engagement_add"),
    path("firm-engagements/<int:pk>/edit/", views.firm_engagement_edit, name="firm_engagement_edit"),
    path("firm-engagements/<int:pk>/delete/", views.firm_engagement_delete, name="firm_engagement_delete"),
    path("firm-engagements/<int:pk>/promote/", views.firm_engagement_promote, name="firm_engagement_promote"),
